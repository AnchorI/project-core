...
import type { DateFilterProps, PaginationProps, SortingProps, IError, IJWT } from "@interfaces/api"
...
abstract class BaseController {
    ...
    protected getSorting = (
        ...
        return {
            ...
            type:
                req.query.sorting_type === SortingType.Desc || req.query.sorting_type === SortingType.Asc
    ...
    protected getBoolean = (value?: core.Query["key"], defaultValue = undefined): boolean | typeof defaultValue => {

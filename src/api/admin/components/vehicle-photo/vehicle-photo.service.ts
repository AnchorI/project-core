...
class VehiclePhotoService extends BaseService {
    public async getList(pagination: PaginationProps): Promise<ListResponse<VehiclePhotoAttributes>> {
        const options: FindAndCountOptions = {
            ...pagination,
            order: [["id", "ASC"]]
        }

        return await findWithPaginate(this.models.VehiclePhoto.scope("list"), options)
    }
}
